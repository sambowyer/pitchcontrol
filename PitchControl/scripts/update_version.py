...
def main():
  ...
  plistpath = scriptpath + "/resources/PitchControl-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PitchControl-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PitchControl-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PitchControl-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PitchControl-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/PitchControl.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/PitchControl.iss",inplace=1):
