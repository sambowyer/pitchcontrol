...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=PitchControl Demo Installer\n"
      else:
        line="OutputBaseFilename=PitchControl Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the PitchControl Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the PitchControl installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=PitchControl Demo installer\n"
     else:
       line="SetupWindowTitle=PitchControl installer\n"
